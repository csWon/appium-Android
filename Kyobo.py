...
class kyobo(bookStore):
    ...
    def kyobo_best_v1(self, keyword, page, n, title):
        ...
        for page in range(50):
            ...
            ActionChains(self.driver).move_to_element(prods[-1]).perform()
            for prod in prods[i:]:
        ...
        if isclicked == True:
            ...
            basket = self.driver.find_element(By.ID, 'basket')
            basket.click()
            super().delay_n(3)
            #
            # yes = self.driver.find_element(By.XPATH, '//*[@id="mainDiv"]/section/div[1]/div[2]/div/div/div/button[2]/span')
            # yes.click()
            # self.driver.implicitly_wait(20)
            #
            # order = self.driver.find_element(By.XPATH, '/html/body/div[3]/section/div[3]/div[2]/div/div/button[2]/span')
            # order.click()
